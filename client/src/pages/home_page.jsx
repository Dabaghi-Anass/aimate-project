          ...
          <div className="hero-text">
            <div className="intro">
              ...
              <p style={{
                ...
                <FormattedMessage
                      id = "app.sub-header"
                      defaultMessage="based on chat gpt language model"
                /></p>
            </div>
            <div className="cta">
      ...
      <footer>
        ...
        <div className="social-media">
          ...
          <ul>
            ...
            <li>
              <a target="_blank" href="mailto:anass.debbaghi123@gmail.com">
                <ion-icon
